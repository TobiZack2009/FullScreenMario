...
Object.assign(window, {
  Thing, setContextStuff, ThingCreate, setCharacter, setSolid, setScenery,
  addThing, placeThing, addText, spawnText, checkTexts, pushPreThing,
  Mushroom, mushroomJump, FireFlower, FireBall, fireEnemy, fireDeleted,
  fireExplodes, Star, Shell, hitShell, moveShell, collideFriendly, jumpEnemy,
  Goomba, killGoomba, DeadGoomba, Koopa, killKoopa, Pirhana, movePirhanaInit,
  movePirhanaNew, movePirhanaRestart, killPirhana, marioAboveEnemy,
  collideEnemy, Podoboo, movePodobooInit, podobooJump, movePodobooUp,
  movePodobooSwitch, movePodobooDown, HammerBro, moveHammerBro, throwHammer,
  jumpHammerBro, Hammer, Cannon, moveCannonInit, BulletBill, Bowser,
  moveBowserInit, moveBowser, bowserJumps, bowserFires, killBowser,
  freezeBowser, BowserFire, moveFlying, WaterBlock, Blooper, moveBlooper,
  squeezeBlooper, unsqueezeBlooper, CheepCheep, setCheepVelocities,
  moveCheepInit, moveCheep, moveCheepJumping, startCheepSpawn, Bubble,
  Lakitu, moveLakituInit, moveLakituInit2, moveLakitu, throwSpiny,
  killLakitu, Spiny, SpinyEgg, moveSpinyEgg, createSpiny, Beetle,
  killBeetle, BeetleShell, Coin, coinBecomesSolid, hitCoin, gainCoin,
  coinEmerge, coinEmergeMovement, coinEmergeMove, coinEmergeMoveParent,
  Mario, placeMario, clearOldMario, Keys, thingStoreVelocity,
  thingRetrieveVelocity, removeCrouch, marioShroom, marioGetsBig,
  marioGetsSmall, marioGetsFire, setMarioSizeSmall, setMarioSizeLarge,
  moveMario, setMarioRunningCycler, marioPaddles, marioBubbles,
  moveMarioVine, unattachMario, marioHopsOff, marioFires, emergeFire,
  marioStar, marioRemoveStar, killMario, marioDropsIn, gameOver,
  gameRestart, Floor, Clouds, Brick, brickBump, makeUsedBlock, brickBreak,
  placeShards, BrickShard, attachEmerge, Block, blockBump,
  blockContentsEmerge, Pipe, PipeSide, PipeVertical, Vine, vineEmerge,
  vineStay, vineEnable, vineMovement, touchVine, Springboard, collideSpring,
  springMarioInit, moveMarioSpringDown, moveMarioSpringUp, moveSpringUp,
  reduceSpringHeight, Stone, GenericStone, RestingStone, RestingStoneUnused,
  RestingStoneUsed, CastleBlock, castleBlockSpawn, castleBlockEvent,
  CastleFireBall, CastleBridge, CastleChain, CastleAxe, CastleAxeFalls,
  CastleAxeKillsBridge, CastleAxeKillsBowser, CastleAxeContinues, Toad,
  Peach, collideCastleNPC, TreeTop, ShroomTop, PlatformTransport, Platform,
  PlatformGenerator, PlatformGeneratorInit, movePlatformSpawn,
  movePlatformNorm, detachMario, Scale, Flag, FlagPole, FlagTop,
  FlagDetector, CastleDoorDetector, FlagCollision, scoreMarioFlag, FlagOff,
  endLevelPoints, endLevelFireworks, explodeFirework, Firework, Coral,
  BridgeBase, WarpWorld, setWarpWorldInit, enableWarpWorldText, resetScenery,
  processSceneryPatterns, SceneryBlocker, Sprite, LocationShifter,
  collideLocationShifter, ScrollBlocker, ScrollEnabler, zoneToggler,
  GenerationStarter, castleDecider, FuncCollider, FuncSpawner, Collider
});
